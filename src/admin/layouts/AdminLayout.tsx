...
import {
  ...
  ToggleRight, MonitorDot, Sparkles, ListChecks, Rocket, ArrowRightLeft, Wallet,
} from "lucide-react";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { adminService, type SmartAlert } from "@/services/adminService";
...
const navItems = [
  ...
  { path: "/admin/payments", icon: Wallet, label: "الدفعات اليدوية" },
...
const AdminLayout = () => {
  ...
  const detectAlerts = useCallback(async () => {
    const detected = await adminService.detectAlerts();
    setAlerts(detected);
  }, []);
