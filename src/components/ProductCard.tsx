  ...
  return (
    ...
    >
      <Link to={`/product/${product.id}`}>
        ...
        <div className="group relative rounded-2xl p-3 bg-gradient-to-b from-primary/10 via-primary/5 to-primary/10 border border-primary/15 shadow-[0_4px_30px_-5px_rgba(0,0,0,0.7),0_0_20px_-5px_hsl(199,89%,48%,0.15),inset_0_0_20px_-5px_hsl(199,89%,48%,0.1)]">
